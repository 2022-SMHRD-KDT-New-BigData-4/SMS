...
public class saveVO {
	...
	private String mb_pic;		// 작성자 사진
	
	public saveVO(int rv_seq, String rv_content, int rv_ratings, int rv_likes, String mb_id, int res_seq,
			String rv_pic1, String rv_hashtag, String rv_date, String mb_name, String mb_nick, String mb_pic) {
		super();
		this.rv_seq = rv_seq;
