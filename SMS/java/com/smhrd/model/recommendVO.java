...
public class recommendVO {
	...
	private int num1;		// 필요없는데이터
	private int num2;		// 필요없는데이터
	...
	public recommendVO(int rv_seq, String rv_content, int rv_ratings, int rv_cnt, int rv_likes, String mb_id,
			int res_seq, String rv_pic1, String rv_pic2, String rv_pic3, String rv_pic4, String rv_pic5,
			String rv_hashtag, String rv_date, int num1, int num2, String mb_id1, String mb_profile, String mb_pic,
			int res_seq1, String res_name, String res_addr, String res_tel, String open_time, String close_time,
			String rest_day, String res_pic1, String res_pic2, String res_pic3, int res_lat, int res_lng, String mb_id2,
			String mb_pw, String mb_name, String mb_nick, String mb_joindate, String mb_type) {
		super();
		this.rv_seq = rv_seq;
